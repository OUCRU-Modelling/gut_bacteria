...
M0        <- 3.33                         ### mutant concentration at this location (xm)

times <- seq(0, 1,len=200)
...
Mini <- function (x){
  a <- abs(x-xm)
  if (a<=(0.01/2))    ### Initial condition for Mutant
  {
    return(M0)
  }
  else    {
...
image(out,legend=TRUE,xlab="times",ylab="position", grid = xgrid$x.mid,which = "M")
lines(times, a1, col="white")
lines(times, a2, col="white")
lines(times, a3, col="black")
>>>>>>> 680aa58c89f2ad5805f2661d0b2743ebe790d042
