...
# alpha       <- c(6.13*10^8, 10^8)     ### Yield of Food to Bacteria and mutants respectively
# beta        <- c(8.208*10^8, 0.01)    ### Consumption of antibiotic in killing Bacteria and mutants respectively
